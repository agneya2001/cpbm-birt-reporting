...
<!--  Step 1 starts here  -->
    <div id="step1"  class="j_channelspopup">
      ...
      <input type="hidden" id="prevstep" name="prevstep" value="" >
       <div class="widgetwizard_stepsbox sixstepswizard">
               ...
               <ul>
                 <li>
                    ...
                    <div class="mandatory_wrapper">
                      ...
                      <form:input class="text js_input_help" tabindex="1" id="channelName" onchange="validate_channelname(event,this)" path="channel.name" 
                      data-toggle="tooltip" data-placement="right" data-original-title='${tooltip_message}' />
                   </div>
                    <div class="main_addnew_formbox_errormsg_popup" id="name_errormsg"></div>
                </li>
                <li>
                    <c:set var="if_mandatory_class" value="nonmandatory_wrapper"/>
                    <c:if test="${channelForm.channel.code != null}">
                    ...
                    <div class="<c:out value='${if_mandatory_class}' />">
                      ...
                      <form:input class="text js_input_help" path="channel.code" id="channelCode" onchange="validate_channelcode(event,this)" tabindex="2" prevValue="${channelForm.channel.code}" 
                      data-toggle="tooltip" data-placement="right" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div class="nonmandatory_wrapper">
                      ...
                      <form:input class="text js_input_help" path="channel.fqdnPrefix" id="channelFQDNPrefix" onchange="validate_channel_fqdn_prefix(event,this)" tabindex="3" 
                      data-toggle="tooltip" data-placement="right" data-original-title='${tooltip_message}' maxlength="35" style="width:100px"/>
                ...
                <li>
                    ...
                    <div class="nonmandatory_wrapper">
                      ...
                      <form:input type="hidden" id="billingGroup"  tabindex="4"  path="channel.billingGroup.name"  value="${selectedCategory}"/>
                      </div>
                    </div>
                ...
                <li>
                    ...
                    <div class="nonmandatory_wrapper">
                      ...
                      <form:textarea class="textarea js_input_help" path="channel.description" id="channelDescription" onchange="validate_channeldesc(event,this)"
                               data-toggle="tooltip" data-placement="right" data-original-title='${tooltip_message}' style="width: 300px; height: 50px; margin-left: 10px;" tabindex="4"></form:textarea>
                    </div>

                   <div class="main_addnew_formbox_errormsg_popup" id="description_errormsg"></div>
                </li>
              </ul>
              <form:input type="hidden" id="channelId"  path="channelId" value="${channelForm.channel.id}"/>
            </div>
         </div>
       </div>
    ...
    <div id="step2" class="j_channelspopup" style="display:none;">
      ...
      <div class="widgetwizard_stepsbox">
         <div class="widgetwizard_steps_contentcontainer sixstepswizard">
             <div class="widgetwizard_stepscenterbar sixstepswizard">
                 <ul>
                    <li class="widgetwizard_stepscenterbar fivestepswizard first"><span class="steps completedsteps"><span class="stepsnumbers">1</span></span><span class="stepstitle"><spring:message htmlEscape="false" code="ui.channel.create.step1.title" /></span></li>
            ...
            <li class="header">
              ...
              <li>
                ...
                <div class="nonmandatory_wrapper">
                    ...
                    <form:select cssClass="text js_input_help" tabindex="1" path="channel.channelBrandingConfigurations.defaultLocale" id="channel_locale" 
                      data-toggle="tooltip" data-global_value="${defaultLocaleValue}" data-placement="top" data-original-title='${tooltip_message}' title="${i18nLanguageTooltip}">
                      ...
                      <c:forEach items="${supportedLocaleList}" var="locale" varStatus="status">
                        <option value='<c:out value="${locale.key}" />' <c:if test="${locale.key == channelLocale}">selected="selected"</c:if>>
              ...
              <li>
                ...
                <div class="nonmandatory_wrapper">
                  ...
                  <form:select cssClass="text js_input_help" tabindex="2" path="channel.channelBrandingConfigurations.defaultTimeZone" id="channel_time_zone"
                      data-toggle="tooltip" data-global_value="${defaultTimeZone}" data-placement="top" data-original-title='${tooltip_message}' title="${i18nLanguageTooltip}">
                    <option value=""><spring:message code="label.choose"/></option>
                    <c:forEach items="${supportedZoneList}" var="choice" varStatus="status">
                      <option value='<c:out value="${choice.value}" />' <c:if test="${choice.value == channelTimeZone}">selected="selected"</c:if>>
              ...
              <li>
                ...
                <div> 
                  ...
                  <form:input class="text js_input_help" data-global_value="${help_desk_email}" tabindex="3" path="channel.channelBrandingConfigurations.helpDeskEmail" id="help_desk_email" 
                  data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                </div>
              ...
              <li>
                ...
                <div> 
                  ...
                  <form:input class="text js_input_help" data-global_value="${help_desk_phone}" tabindex="4" path="channel.channelBrandingConfigurations.helpDeskPhone" id="help_desk_phone" 
                  data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                </div>
              ...
              <li>
                ...
                <div> 
                  ...
                  <form:radiobutton disabled="${isDefaultChannel}" style="margin-top:0px;" class="js_input_help" tabindex="5" data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}' path="channel.channelBrandingConfigurations.signupAllowed" data-global_value="${signup_allowed}" value="yes" />
                  <spring:message code='label.yes' />
                  </span>
                  <span class="label" style="width:80px;">
                  <form:radiobutton disabled="${isDefaultChannel}"  tabindex="5" style="margin-top:0px;" class="js_input_help" data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}' path="channel.channelBrandingConfigurations.signupAllowed" data-global_value="${signup_allowed}" value="no" />
              ...
              <li>
                ...
                <spring:message code="config.com.citrix.cpbm.accountManagement.onboarding.emailDomain.whitelist.description" htmlEscape="false" var="tooltip_message"/> 
                  <form:input class="text js_input_help" data-global_value="${whitelistdomains}" tabindex="8" data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}' path="channel.channelBrandingConfigurations.whitelistdomains" id="whitelistdomains"/>
                </div>
               ...
               <li class="header">
                 ...
                 <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" data-global_value="${marketing_blog_url}" tabindex="1" path="channel.channelBrandingConfigurations.blogUrl" id="marketing_blog_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" data-global_value="${marketing_contact_url}" tabindex="2" path="channel.channelBrandingConfigurations.contactUrl" id="marketing_contact_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" tabindex="3" data-global_value="${marketing_forum_url}" path="channel.channelBrandingConfigurations.forumUrl" id="marketing_forum_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" tabindex="4" data-global_value="${marketing_help_url}" path="channel.channelBrandingConfigurations.helpUrl" id="marketing_help_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" tabindex="7" data-global_value="${marketing_privacy_url}" path="channel.channelBrandingConfigurations.privacyUrl" id="marketing_privacy_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" tabindex="8" data-global_value="${marketing_support_url}" path="channel.channelBrandingConfigurations.supportUrl" id="marketing_support_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                ...
                <li>
                    ...
                    <div> 
                      ...
                      <form:input class="text js_input_help" tabindex="9" data-global_value="${marketing_tou_url}" path="channel.channelBrandingConfigurations.touUrl" id="marketing_tou_url" 
                      data-toggle="tooltip" data-placement="top" data-original-title='${tooltip_message}'/>
                    </div>
                          ...
                          <ul>
                           <li class="subselection" >
                            ...
                            <li class="subselection" >
                                 ...
                                 <span class="description subdescription ellipsis" id="conf_edit_fqdn_prefix"></span>
                            </li>
                            <li class="subselection" >
                                 <span class="label sublabel"><spring:message code="label.billing.group"/></span>
                                 <span class="description subdescription ellipsis" id="conf_edit_billinggroup"></span>
                            </li>
                            <li class="subselection" >
...
<!--  Step 6 starts here  -->
  <div id="step6" class="j_channelspopup" style="display:none;">
       ...
       <div class="widgetwizard_steps_contentcontainer sixstepswizard">
           <div class="widgetwizard_stepscenterbar sixstepswizard">
               <ul>
                     ...
                     <li class="widgetwizard_stepscenterbar fivestepswizard last"><span class="steps last active"><span class="stepsnumbers last">6</span></span><span class="stepstitle last active"><spring:message htmlEscape="false" code="ui.channel.create.step6.title" /></span></li>
               </ul>
           </div>
       </div>
    </div>
    ...
    <input type="hidden" id="result" value="failure">
  </div>
<!--  Step 6 ends here  -->
...
<script type="text/javascript">
  ...
  var channel_blacklistcountries = [];
  var channel_whitelistcountries = [];
  
  <c:forEach items="${channel_blacklistcountries}" var="blc"> 
    channel_blacklistcountries.push("${blc.countryCode2}")
  </c:forEach>
  $("#blacklistcountries").val(channel_blacklistcountries).select2();
  
  <c:forEach items="${channel_whitelistcountries}" var="wlc"> 
    channel_whitelistcountries.push("${wlc.countryCode2}")
  </c:forEach>
  $("#whitelistcountries").val(channel_whitelistcountries).select2();
</script>
